    ...
    return (
        <div className="container-custom py-8">
            <div className="flex items-center gap-4 mb-8">
                <Link href="/admin/reports" className="p-2 -ml-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-[#0f0f0f] transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Daily Report */}
                <Link href="/admin/reports/daily" className="block h-full">
                ...
                {/* Weekly Report */}
                <Link href="/admin/reports/weekly" className="block h-full">
                    <div className="ek-card h-full p-8 hover:border-red-100 group transition-all">
                ...
                {/* Monthly Report */}
                <Link href="/admin/reports/monthly" className="block h-full">
                    <div className="ek-card h-full p-8 hover:border-red-100 group transition-all">
