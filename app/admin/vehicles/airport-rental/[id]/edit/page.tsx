...
import { ChevronRight, ArrowLeft, Edit3, PlaneTakeoff } from "lucide-react";
import VehicleForm from "@/components/admin/VehicleForm";
import { useParams } from "next/navigation";
import { useState, useEffect } from "react";
import { getVehicleById } from "@/lib/actions/vehicleActions";

export default function EditAirportRentalVehiclePage() {
        ...
        return (
            <div className="min-h-screen bg-[#fcfcfc] flex flex-col items-center justify-center p-8 text-center">
                <div className="relative">
                    ...
                    <div className="absolute top-0 h-16 w-16 rounded-full border-4 border-purple-400 border-t-transparent animate-spin"></div>
                </div>
                ...
                <div className="mb-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-gray-500 font-medium">Modifying details for <span className="text-purple-600 font-bold">{vehicle.brand} {vehicle.model}</span> • {vehicle.plateNumber}</p>
                        </div>
                    </div>
                </div>
