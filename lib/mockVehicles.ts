...
export const mockVehicles: Vehicle[] = [
    ...
    },
    {
        ...
        description: "Sleek, sporty, and reliable. The Honda Civic offers a smooth ride with advanced safety features and a spacious interior.",
        image: "https://images.unsplash.com/photo-1594070319944-7c0c63146b7c?auto=format&fit=crop&q=80&w=1000",
        equipment: ["GPS", "Airbags", "Music system", "Reverse camera", "Air conditioning"]
    },
    {
        id: "3",
        ...
        ratePerMonth: 95000,
        availabilityStatus: "Available",
        serviceCategory: "Budget",
        description: "Compact and easy to handle, the Suzuki Alto is the best choice for navigating tight city streets on a budget.",
        image: "https://images.unsplash.com/photo-1621245084961-4148417c8008?auto=format&fit=crop&q=80&w=1000",
        equipment: ["Air conditioning", "Music system", "Airbags"]
    },
    {
        id: "4",
        brand: "Mercedes",
